...
To know about SensorThings API, we suggest the module 'SensorWeb' Chapter 3 and 4: [SensorThings API](https://github.com/oer4sdi/OER-SensorWeb/blob/main/Storyboard.MD)
