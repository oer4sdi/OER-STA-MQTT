...
**Step 4:** for example, I have used tommy as my Client ID. Now, add the topic in the MQTT node (remember that MQTT has a hierarchy based system for its data communication)
